...
export enum RedirectApiApiKeys {
    access_token,
}
...
export class RedirectApi {
    ...
    public setApiKey(key: RedirectApiApiKeys, value: string) {
        (this.authentications as any)[RedirectApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param options 
     */
    public async redirect (id: string, options?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/redirect';
