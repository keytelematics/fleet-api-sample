...
export enum SmsGatewayProvidersTypesApiApiKeys {
    access_token,
}

export class SmsGatewayProvidersTypesApi {
    ...
    public setApiKey(key: SmsGatewayProvidersTypesApiApiKeys, value: string) {
        (this.authentications as any)[SmsGatewayProvidersTypesApiApiKeys[key]].apiKey = value;
    }
