...
export enum SmsGatewayProvidersApiApiKeys {
    access_token,
}

export class SmsGatewayProvidersApi {
    ...
    public setApiKey(key: SmsGatewayProvidersApiApiKeys, value: string) {
        (this.authentications as any)[SmsGatewayProvidersApiApiKeys[key]].apiKey = value;
    }
