...
export enum AssetRatingProfilesApiApiKeys {
    access_token,
}

export class AssetRatingProfilesApi {
    ...
    public setApiKey(key: AssetRatingProfilesApiApiKeys, value: string) {
        (this.authentications as any)[AssetRatingProfilesApiApiKeys[key]].apiKey = value;
    }
