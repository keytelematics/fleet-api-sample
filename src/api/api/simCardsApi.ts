...
export enum SimCardsApiApiKeys {
    access_token,
}

export class SimCardsApi {
    ...
    public setApiKey(key: SimCardsApiApiKeys, value: string) {
        (this.authentications as any)[SimCardsApiApiKeys[key]].apiKey = value;
    }
