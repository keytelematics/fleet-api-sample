...
export enum MapSetsApiApiKeys {
    access_token,
}

export class MapSetsApi {
    ...
    public setApiKey(key: MapSetsApiApiKeys, value: string) {
        (this.authentications as any)[MapSetsApiApiKeys[key]].apiKey = value;
    }
