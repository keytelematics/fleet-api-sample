...
export enum ReportTemplatesApiApiKeys {
    access_token,
}
...
export class ReportTemplatesApi {
    ...
    public setApiKey(key: ReportTemplatesApiApiKeys, value: string) {
        (this.authentications as any)[ReportTemplatesApiApiKeys[key]].apiKey = value;
    }
