...
export enum AssetTagsApiApiKeys {
    access_token,
}

export class AssetTagsApi {
    ...
    public setApiKey(key: AssetTagsApiApiKeys, value: string) {
        (this.authentications as any)[AssetTagsApiApiKeys[key]].apiKey = value;
    }
