...
export enum ExportTasksApiApiKeys {
    access_token,
}

export class ExportTasksApi {
    ...
    public setApiKey(key: ExportTasksApiApiKeys, value: string) {
        (this.authentications as any)[ExportTasksApiApiKeys[key]].apiKey = value;
    }
