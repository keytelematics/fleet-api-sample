...
export enum AssetCategoriesApiApiKeys {
    access_token,
}

export class AssetCategoriesApi {
    ...
    public setApiKey(key: AssetCategoriesApiApiKeys, value: string) {
        (this.authentications as any)[AssetCategoriesApiApiKeys[key]].apiKey = value;
    }
