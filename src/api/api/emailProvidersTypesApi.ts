...
export enum EmailProvidersTypesApiApiKeys {
    access_token,
}

export class EmailProvidersTypesApi {
    ...
    public setApiKey(key: EmailProvidersTypesApiApiKeys, value: string) {
        (this.authentications as any)[EmailProvidersTypesApiApiKeys[key]].apiKey = value;
    }
