...
export enum AssetGroupsApiApiKeys {
    access_token,
}
...
export class AssetGroupsApi {
    ...
    public setApiKey(key: AssetGroupsApiApiKeys, value: string) {
        (this.authentications as any)[AssetGroupsApiApiKeys[key]].apiKey = value;
    }
