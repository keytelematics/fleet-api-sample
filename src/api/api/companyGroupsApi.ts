...
export enum CompanyGroupsApiApiKeys {
    access_token,
}
...
export class CompanyGroupsApi {
    ...
    public setApiKey(key: CompanyGroupsApiApiKeys, value: string) {
        (this.authentications as any)[CompanyGroupsApiApiKeys[key]].apiKey = value;
    }
