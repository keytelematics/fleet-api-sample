...
export enum DeviceTypesApiApiKeys {
    access_token,
}
...
export class DeviceTypesApi {
    ...
    public setApiKey(key: DeviceTypesApiApiKeys, value: string) {
        (this.authentications as any)[DeviceTypesApiApiKeys[key]].apiKey = value;
    }
