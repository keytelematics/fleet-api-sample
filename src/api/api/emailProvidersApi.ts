...
export enum EmailProvidersApiApiKeys {
    access_token,
}
...
export class EmailProvidersApi {
    ...
    public setApiKey(key: EmailProvidersApiApiKeys, value: string) {
        (this.authentications as any)[EmailProvidersApiApiKeys[key]].apiKey = value;
    }
