...
export enum CostCentresApiApiKeys {
    access_token,
}

export class CostCentresApi {
    ...
    public setApiKey(key: CostCentresApiApiKeys, value: string) {
        (this.authentications as any)[CostCentresApiApiKeys[key]].apiKey = value;
    }
