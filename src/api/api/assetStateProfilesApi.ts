...
export enum AssetStateProfilesApiApiKeys {
    access_token,
}

export class AssetStateProfilesApi {
    ...
    public setApiKey(key: AssetStateProfilesApiApiKeys, value: string) {
        (this.authentications as any)[AssetStateProfilesApiApiKeys[key]].apiKey = value;
    }
