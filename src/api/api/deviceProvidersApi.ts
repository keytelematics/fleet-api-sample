...
export enum DeviceProvidersApiApiKeys {
    access_token,
}

export class DeviceProvidersApi {
    ...
    public setApiKey(key: DeviceProvidersApiApiKeys, value: string) {
        (this.authentications as any)[DeviceProvidersApiApiKeys[key]].apiKey = value;
    }
