...
export class AssetRatingProfileListItem {
    /**
    ...
    */
    'state'?: AssetRatingProfileListItem.StateEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "AssetRatingProfileListItem.StateEnum"
        },
        {
            "name": "items",
            "baseName": "items",
    ...
    static getAttributeTypeMap() {
        return AssetRatingProfileListItem.attributeTypeMap;
    }
}
