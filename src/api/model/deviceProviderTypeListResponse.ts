...
*/
export class DeviceProviderTypeListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<DeviceProviderTypeListItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<DeviceProviderTypeListItem>"
        }    ];

    static getAttributeTypeMap() {
        return DeviceProviderTypeListResponse.attributeTypeMap;
    }
}
