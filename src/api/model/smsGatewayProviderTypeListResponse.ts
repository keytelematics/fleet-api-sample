...
*/
export class SmsGatewayProviderTypeListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<SmsGatewayProviderTypeListItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<SmsGatewayProviderTypeListItem>"
        }    ];

    static getAttributeTypeMap() {
        return SmsGatewayProviderTypeListResponse.attributeTypeMap;
    }
}
