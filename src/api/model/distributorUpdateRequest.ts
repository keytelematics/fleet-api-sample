...
export class DistributorUpdateRequest {
    /**
    ...
    */
    'state'?: DistributorUpdateRequest.StateEnum;
    'entity'?: EntityInfo;
    'limits'?: SoftLimits;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "DistributorUpdateRequest.StateEnum"
        },
        {
            "name": "entity",
            "baseName": "entity",
    ...
    static getAttributeTypeMap() {
        return DistributorUpdateRequest.attributeTypeMap;
    }
}
