...
*/
export class AssetRatingProfileListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<AssetRatingProfileListItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<AssetRatingProfileListItem>"
        }    ];

    static getAttributeTypeMap() {
        return AssetRatingProfileListResponse.attributeTypeMap;
    }
}
