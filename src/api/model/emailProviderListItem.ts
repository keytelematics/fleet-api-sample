...
export class EmailProviderListItem {
    /**
    ...
    */
    'state'?: EmailProviderListItem.StateEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "EmailProviderListItem.StateEnum"
        },
        {
            "name": "modifiedDate",
    ...
    static getAttributeTypeMap() {
        return EmailProviderListItem.attributeTypeMap;
    }
}
