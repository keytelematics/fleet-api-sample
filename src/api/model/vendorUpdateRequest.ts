...
export class VendorUpdateRequest {
    /**
    ...
    */
    'state'?: VendorUpdateRequest.StateEnum;
    'entity'?: EntityInfo;
    'limits'?: SoftLimits;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "VendorUpdateRequest.StateEnum"
        },
        {
            "name": "entity",
            "baseName": "entity",
    ...
    static getAttributeTypeMap() {
        return VendorUpdateRequest.attributeTypeMap;
    }
}
