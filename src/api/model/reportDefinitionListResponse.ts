...
*/
export class ReportDefinitionListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<ReportDefinitionResponse>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<ReportDefinitionResponse>"
        }    ];

    static getAttributeTypeMap() {
        return ReportDefinitionListResponse.attributeTypeMap;
    }
}
