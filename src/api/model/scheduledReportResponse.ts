...
export class ScheduledReportResponse {
    ...
    */
    'state'?: ScheduledReportResponse.StateEnum;
    /**
    * The type of scheduled report.
    */
    'scheduleType'?: ScheduledReportResponse.ScheduleTypeEnum;
    'schedule'?: Schedule;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "ScheduledReportResponse.StateEnum"
        },
        {
            "name": "scheduleType",
            "baseName": "scheduleType",
            "type": "ScheduledReportResponse.ScheduleTypeEnum"
        },
        {
            "name": "schedule",
            "baseName": "schedule",
    ...
    static getAttributeTypeMap() {
        return ScheduledReportResponse.attributeTypeMap;
    }
}
