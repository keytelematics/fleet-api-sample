...
export class AlertUpdateRequest {
    ...
    */
    'state'?: AlertUpdateRequest.StateEnum;
    'costCentre'?: IdName;
    /**
    * The priority of this alert
    */
    'priority'?: AlertUpdateRequest.PriorityEnum;
    'filter'?: EventFilter;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "AlertUpdateRequest.StateEnum"
        },
        {
            "name": "costCentre",
            "baseName": "costCentre",
        ...
        },
        {
            "name": "priority",
            "baseName": "priority",
            "type": "AlertUpdateRequest.PriorityEnum"
        },
        {
            "name": "filter",
            "baseName": "filter",
    ...
    static getAttributeTypeMap() {
        return AlertUpdateRequest.attributeTypeMap;
    }
}
