...
export class AssetStateProfileUpdateRequest {
    /**
    ...
    */
    'state'?: AssetStateProfileUpdateRequest.StateEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "AssetStateProfileUpdateRequest.StateEnum"
        },
        {
            "name": "items",
            "baseName": "items",
    ...
    static getAttributeTypeMap() {
        return AssetStateProfileUpdateRequest.attributeTypeMap;
    }
}
