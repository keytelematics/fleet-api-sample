...
*/
export class EmailProviderListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<EmailProviderListItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<EmailProviderListItem>"
        }    ];

    static getAttributeTypeMap() {
        return EmailProviderListResponse.attributeTypeMap;
    }
}
