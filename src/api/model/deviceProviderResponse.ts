...
export class DeviceProviderResponse {
    /**
    ...
    */
    'state'?: DeviceProviderResponse.StateEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "DeviceProviderResponse.StateEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return DeviceProviderResponse.attributeTypeMap;
    }
}
