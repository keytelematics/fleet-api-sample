...
export class DashboardWidgetDataSource {
    'id'?: string | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "options",
            "baseName": "options",
            "type": "DashboardWidgetDataSourceOptions"
        },
        {
            "name": "data",
            "baseName": "data",
    ...
    static getAttributeTypeMap() {
        return DashboardWidgetDataSource.attributeTypeMap;
    }
}

export namespace DashboardWidgetDataSource {
    export enum TypeEnum {
        Report = <any> 'analytics-report',
        Mock = <any> 'analytics-mock'
    }
}
