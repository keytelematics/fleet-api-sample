...
export class OverspeedProfileUpdateRequest {
    /**
    ...
    */
    'state'?: OverspeedProfileUpdateRequest.StateEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "OverspeedProfileUpdateRequest.StateEnum"
        },
        {
            "name": "items",
            "baseName": "items",
    ...
    static getAttributeTypeMap() {
        return OverspeedProfileUpdateRequest.attributeTypeMap;
    }
}
