...
*/
export class EmailProviderTypeListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<EmailProviderTypeListItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<EmailProviderTypeListItem>"
        }    ];

    static getAttributeTypeMap() {
        return EmailProviderTypeListResponse.attributeTypeMap;
    }
}
