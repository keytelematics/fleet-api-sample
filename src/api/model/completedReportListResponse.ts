...
*/
export class CompletedReportListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<CompletedReportResponse>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<CompletedReportResponse>"
        }    ];

    static getAttributeTypeMap() {
        return CompletedReportListResponse.attributeTypeMap;
    }
}
