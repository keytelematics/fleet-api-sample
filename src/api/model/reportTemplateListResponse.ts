...
*/
export class ReportTemplateListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<ReportTemplateResponse>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<ReportTemplateResponse>"
        }    ];

    static getAttributeTypeMap() {
        return ReportTemplateListResponse.attributeTypeMap;
    }
}
