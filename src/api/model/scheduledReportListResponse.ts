...
*/
export class ScheduledReportListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<ScheduledReportListItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<ScheduledReportListItem>"
        }    ];

    static getAttributeTypeMap() {
        return ScheduledReportListResponse.attributeTypeMap;
    }
}
