...
export class OverspeedProfileListItem {
    /**
    ...
    */
    'state'?: OverspeedProfileListItem.StateEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "OverspeedProfileListItem.StateEnum"
        },
        {
            "name": "items",
            "baseName": "items",
    ...
    static getAttributeTypeMap() {
        return OverspeedProfileListItem.attributeTypeMap;
    }
}
