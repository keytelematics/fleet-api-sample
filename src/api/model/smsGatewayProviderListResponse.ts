...
*/
export class SmsGatewayProviderListResponse {
    /**
    ...
    */
    'limit': number;
    'items': Array<SmsGatewayProviderListItem>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<SmsGatewayProviderListItem>"
        }    ];

    static getAttributeTypeMap() {
        return SmsGatewayProviderListResponse.attributeTypeMap;
    }
}
