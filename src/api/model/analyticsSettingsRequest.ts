...
export class AnalyticsSettingsRequest {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "row",
            "baseName": "row",
            "type": "AnalyticsSettingsRequest.RowEnum"
        },
        {
            "name": "group",
            "baseName": "group",
            "type": "AnalyticsSettingsRequest.GroupEnum"
        }    ];

    static getAttributeTypeMap() {
        return AnalyticsSettingsRequest.attributeTypeMap;
    }
}
